...
class SecureWare
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        if($request->is('/') || $request->is('register') || $request->is('processRegister') || $request->is('login') || $request->is('processLogin') || $request->is('logout') || $request->is('jobrest') || $request->is('profilerest') || $request->is('jobrest/*') || $request->is('profilerest/*'))
        {
            $secureCheck = false;
        }
