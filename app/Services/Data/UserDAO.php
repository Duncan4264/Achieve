...
class UserDAO
{
    ...
    public function createUser(UserModel $user)
    {
       ...
       VALUES 
       (NULL, :username, :password, :email,  :firstname, :lastname)');
    ...
    public function FindByUser(CredentialModel $user)
    {
        try {
            ...
            if($stmt->rowCount() == 1)
            {
                ...
                $user = new UserModel($data['first_name'], $data['last_name'],$data['username'], $data['password'], $data['email'], $data['id'], $data['role']);
                // Finally return true
